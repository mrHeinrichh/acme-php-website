...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email', Username='$username', Password='$password',Address='$add' where ID='$eid'");
...
<a href="change-image.php?userid=<?php echo $row['ID'];?>">Change Image</a>
        ...
        <div class="form-group">
        	<input type="username" class="form-control" name="username" value="<?php  echo $row['username'];?>" required="true">
        </div>

        <div class="form-group">
        	<input type="password" class="form-control" name="password" value="<?php  echo $row['password'];?>" required="true">
        </div>
