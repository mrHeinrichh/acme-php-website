...
move_uploaded_file($_FILES["photo"]["tmp_name"],"photo/".$imgnewfile);
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set photo='$imgnewfile' where id='$uid' ");
    if ($query) {
    	//Old pic
...
<img src="photo/<?php  echo $row['photo'];?>" width="120" height="120">
		</div>
