...
try {
   mysqli_query($con,'START TRANSACTION');
	...
	$query = "insert into hconsultation (petID,ID,conditionz,hc_date,note) value(?,?,?,?,?)";
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
      ...
      <div class="form-group">
        ...
        <select id="disease" name="conditionz" style="width: 12em;">
         ...
         <div class="form-group">
        	<input type="date" class="form-control" name="consult_date" placeholder="consult_date" required="true">
        </div>
