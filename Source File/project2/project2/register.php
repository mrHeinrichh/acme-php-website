...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, username, password, Address,ProfilePic) value('$fname','$lname', '$contno', '$email', '$username', '$password', '$add','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <input type="username" class="form-control" name="username" placeholder="Enter your username id" required="true">
        </div>
        <div class="form-group">
