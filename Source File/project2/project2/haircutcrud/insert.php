...
$query=mysqli_query($con, "insert into haircut(groomtype,ProfilePic) value('$groomtype', '$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
						<div class="row">
								<div class="col"><input type="text" class="form-control" name="groomtype" placeholder="Groom type" required="true">
								</div>
						</div>
				</div>
         <div class="form-group">
