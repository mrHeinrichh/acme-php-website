...
$q2 = 'INSERT INTO trans (custid,petID,serviceID,ID,tdate) VALUES ( ?,?,?,?,NOW())';
$stmt2 = mysqli_prepare($con, $q2);

mysqli_stmt_bind_param($stmt2, 'iiii',$d,$a ,$b,$c);
foreach ($_SESSION["cart_products"] as $cart_itm){

  $a=$cart_itm['petID'];
  $b=$cart_itm['serviceID'];
  $c=$_SESSION['ID'];
  $d=$_SESSION['custid'];
...
<h1 align="center">Official Recipet</h1>

<table width="100%"  cellpadding="6" cellspacing="0"><thead><tr><th></th><th>Name</th><th>Service</th><th>Price</th><th>Subtotal</th></tr></thead>
  <tbody>
  <?php
// echo "<pre>";
// print_r($_SESSION);
...
<div align="center">Amount Payable : <?php echo sprintf("%01.2f", $total); ?></br><a href="index.php" class="button">Done</a></div>
